...
{
  ((LPC_RIT_TypeDef *) ((0x40080000UL) + 0x30000) )->RICTRL |= (1<<3); // Start timer counter
  return;
}
...
{
  ((LPC_SC_TypeDef *) ((0x40080000UL) + 0x7C000) )->PCLKSEL1 &= ~(3<<26); // All 1s except positions 26 and 27 (we clear RIT bits)
  ((LPC_SC_TypeDef *) ((0x40080000UL) + 0x7C000) )->PCLKSEL1 |= (1<<26); // RIT Clock = CCLK (1 MHz clock)
